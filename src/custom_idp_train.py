...
model1_dir = "trained_custom_idp_ppo_model"
model2_dir = "trained_custom_idp_sac_model"
model3_dir = "trained_custom_idp_td3_model"
...
train_model(PPO, env, model1_dir, "custom_idp_ppo")
train_model(SAC, env, model2_dir, "custom_idp_sac")
train_model(TD3, env, model3_dir, "custom_idp_td3")
