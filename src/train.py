...
cartpole_study.optimize(obj, n_trials = 1)

with open("C:/Users/35385/Desktop/FYP-2024/saved_studies/constant_lr_cartpole-v1.pkl", "wb") as fout:
...
with open("C:/Users/35385/Desktop/FYP-2024/saved_studies/linear_lr_cartpole-v1.pkl", "wb") as fout:
    pickle.dump(cartpole_study, fout)

# exponential decreasing lr
eval_cb = EvalCallback(env, best_model_save_path=os.path.join(trained_dir, model_exponential_dir + '_best'),
                        log_path=logdir, eval_freq=5000, n_eval_episodes=10,
                        deterministic=True, render=False, callback_after_eval=reward_cb)
...
with open("C:/Users/35385/Desktop/FYP-2024/saved_studies/exponential_lr_cartpole-v1.pkl", "wb") as fout:
    pickle.dump(cartpole_study, fout)

# Adaptive lr: no sense  for default cartpole: 
'''eval_cb = EvalCallback(env, best_model_save_path=os.path.join(trained_dir, model_adaptive_dir + '_best'),
                        log_path=logdir, eval_freq=5000, n_eval_episodes=10,
                        deterministic=True, render=False, callback_after_eval=reward_cb)
...
with open("C:/Users/35385/Desktop/FYP-2024/saved_studies/adaptive_lr_cartpole-v1.pkl", "wb") as fout:
    pickle.dump(cartpole_study, fout)'''

# CustomCartpole-v0

trained_dir = "C:/Users/35385/Desktop/FYP-2024/trained_models"
logdir = 'C:/Users/35385/Desktop/FYP-2024/logs/custom_cartpole_v0/'
...
with open("C:/Users/35385/Desktop/FYP-2024/saved_studies/constant_lr_custom_cartpole-v0.pkl", "wb") as fout:
    pickle.dump(cartpole_study, fout)
...
with open("C:/Users/35385/Desktop/FYP-2024/saved_studies/linear_lr_custom_cartpole-v0.pkl", "wb") as fout:
    pickle.dump(cartpole_study, fout)
...
with open("C:/Users/35385/Desktop/FYP-2024/saved_studies/exponential_lr_custom_cartpole-v0.pkl", "wb") as fout:
    pickle.dump(cartpole_study, fout)
...
with open("C:/Users/35385/Desktop/FYP-2024/saved_studies/adaptive_lr_custom_cartpole-v0.pkl", "wb") as fout:
    pickle.dump(cartpole_study, fout)

# CustomCartpole-v1

trained_dir = "C:/Users/35385/Desktop/FYP-2024/trained_models"
logdir = 'C:/Users/35385/Desktop/FYP-2024/logs/custom_cartpole_v1/'
...
with open("C:/Users/35385/Desktop/FYP-2024/saved_studies/constant_lr_custom_cartpole-v1.pkl", "wb") as fout:
    pickle.dump(cartpole_study, fout)
...
with open("C:/Users/35385/Desktop/FYP-2024/saved_studies/linear_lr_custom_cartpole-v1.pkl", "wb") as fout:
    pickle.dump(cartpole_study, fout)
...
with open("C:/Users/35385/Desktop/FYP-2024/saved_studies/exponential_lr_custom_cartpole-v1.pkl", "wb") as fout:
    pickle.dump(cartpole_study, fout)
...
with open("C:/Users/35385/Desktop/FYP-2024/saved_studies/adaptive_lr_custom_cartpole-v1.pkl", "wb") as fout:
    pickle.dump(cartpole_study, fout)