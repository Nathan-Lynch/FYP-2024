...
gym.envs.register(
    ...
    entry_point='custom_inverted_double_pendulum:CustomInvertedDoublePendulumEnvV0',
)

gym.envs.register(
    id='CustomInvertedDoublePendulum-v1',
    entry_point='custom_inverted_double_pendulum:CustomInvertedDoublePendulumEnvV1',
)

gym.envs.register(
    id='CustomInvertedDoublePendulum-v2',
    entry_point='custom_inverted_double_pendulum:CustomInvertedDoublePendulumEnvV2',
)